...
def _generate_deck_slide(task: str, audience: str, points: list, tone: str) -> dict:
    return {
        ...
        "body_bullets": points or [
            ...
            f"JV: KTV {JV_STRUCTURE['ktv']['stake']}% | IFS up to {JV_STRUCTURE['ifs']['stake_max']}% | Skyller up to {JV_STRUCTURE['skyller']['stake_max']}%",
        ],
...
def _generate_term_sheet(task: str, audience: str, points: list, tone: str) -> dict:
    return {
        ...
        "parties": [
            ...
            f"Skyller (up to {JV_STRUCTURE['skyller']['stake_max']}%)",
        ],
        "key_terms": {
            ...
            "skyller_contribution": "O&G inspection and hazardous site expertise",
            "governance": "KTV retains board control; IFS and Skyller have board seats",
            "exclusivity": "IFS is sole FM channel; Skyller is sole O&G channel in Thailand",
