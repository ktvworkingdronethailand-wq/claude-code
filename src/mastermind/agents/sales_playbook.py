...
ACCOUNT_DATABASE = [
    ...
    {"name": "PTT Refinery Rayong", "sector": "o_and_g", "sqm": 35_000, "owner": "PTT", "route": "ifs"},
    {"name": "IRPC Refinery", "sector": "o_and_g", "sqm": 28_000, "owner": "IRPC", "route": "ifs"},
...
def _sector_playbook(sector: str) -> dict:
    playbooks = {
        ...
        "o_and_g": {
            "value_prop": "ATEX-aware inspection, zero confined-space entry, KTV expertise",
