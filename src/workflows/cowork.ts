...
export const WEEKLY_ROUTINES: WeeklyRoutine[] = [
  ...
  // ── Company Strategy Agent Routines (Tuesday + Friday) ──────
  {
    id: 'routine-tuesday-company-marketing',
    name: 'Company Agent Marketing Scans',
    day: 'tuesday',
    time: '09:30',
    teams: ['growth', 'ecosystem', 'intelligence'],
    description: 'All 13 company agents scan target company intel, ESG reports, and FM procurement — results sync to Google Drive',
    tasks: [
      { id: 'ca-jll-mkt', name: 'JLL Thailand marketing scan + GDrive sync', team: 'growth', agent: 'market_intelligence_strategist', action: 'scan-company-intel', outputKey: 'jllMktScan' },
      { id: 'ca-kf-mkt', name: 'Knight Frank marketing scan + GDrive sync', team: 'growth', agent: 'sales_playbook_account_selector', action: 'scan-company-intel', outputKey: 'kfMktScan' },
      { id: 'ca-cbre-mkt', name: 'CBRE Thailand marketing scan + GDrive sync', team: 'growth', agent: 'market_intelligence_strategist', action: 'scan-company-intel', outputKey: 'cbreMktScan' },
      { id: 'ca-shell-mkt', name: 'Shell Thailand marketing scan + GDrive sync', team: 'ecosystem', agent: 'partner_strategy_architect', action: 'scan-company-intel', outputKey: 'shellMktScan' },
      { id: 'ca-ptt-mkt', name: 'PTT/OR marketing scan + GDrive sync', team: 'ecosystem', agent: 'partner_strategy_architect', action: 'scan-company-intel', outputKey: 'pttMktScan' },
      { id: 'ca-bgk-mkt', name: 'Bangchak marketing scan + GDrive sync', team: 'ecosystem', agent: 'smart_green_product_orchestrator', action: 'scan-company-intel', outputKey: 'bgkMktScan' },
      { id: 'ca-kbank-mkt', name: 'KBANK green finance marketing scan + GDrive sync', team: 'intelligence', agent: 'financial_model_capital_planner', action: 'scan-company-intel', outputKey: 'kbankMktScan' },
      { id: 'ca-scb-mkt', name: 'SCB ESG marketing scan + GDrive sync', team: 'intelligence', agent: 'financial_model_capital_planner', action: 'scan-company-intel', outputKey: 'scbMktScan' },
      { id: 'ca-bbl-mkt', name: 'BBL Bualuang Green marketing scan + GDrive sync', team: 'intelligence', agent: 'financial_model_capital_planner', action: 'scan-company-intel', outputKey: 'bblMktScan' },
      { id: 'ca-ob-mkt', name: 'One Bangkok marketing scan + GDrive sync', team: 'growth', agent: 'deal_design_pitch_engineer', action: 'scan-company-intel', outputKey: 'obMktScan' },
      { id: 'ca-fp-mkt', name: 'Frasers Property marketing scan + GDrive sync', team: 'ecosystem', agent: 'smart_green_product_orchestrator', action: 'scan-company-intel', outputKey: 'fpMktScan' },
      { id: 'ca-cpn-mkt', name: 'Central Pattana marketing scan + GDrive sync', team: 'growth', agent: 'sales_playbook_account_selector', action: 'scan-company-intel', outputKey: 'cpnMktScan' },
      { id: 'ca-wha-mkt', name: 'WHA Group marketing scan + GDrive sync', team: 'growth', agent: 'operations_compliance_mission_planner', action: 'scan-company-intel', outputKey: 'whaMktScan' },
    ],
  },
  {
    id: 'routine-friday-company-sales',
    name: 'Company Agent Sales Pipeline + Docs Sync',
    day: 'friday',
    time: '10:00',
    teams: ['growth', 'ecosystem', 'revenue', 'intelligence'],
    description: 'All 13 company agents update sales pipelines and sync strategy docs to Google Drive',
    tasks: [
      { id: 'ca-jll-sales', name: 'JLL sales pipeline update + GDrive sync', team: 'growth', agent: 'market_intelligence_strategist', action: 'update-pipeline', outputKey: 'jllSales' },
      { id: 'ca-kf-sales', name: 'Knight Frank sales pipeline + GDrive sync', team: 'growth', agent: 'sales_playbook_account_selector', action: 'update-pipeline', outputKey: 'kfSales' },
      { id: 'ca-cbre-sales', name: 'CBRE enterprise sales pipeline + GDrive sync', team: 'growth', agent: 'market_intelligence_strategist', action: 'update-pipeline', outputKey: 'cbreSales' },
      { id: 'ca-shell-sales', name: 'Shell station onboarding pipeline + GDrive sync', team: 'ecosystem', agent: 'partner_strategy_architect', action: 'update-pipeline', outputKey: 'shellSales' },
      { id: 'ca-ptt-sales', name: 'PTT POC pipeline + GDrive sync', team: 'ecosystem', agent: 'partner_strategy_architect', action: 'update-pipeline', outputKey: 'pttSales' },
      { id: 'ca-bgk-sales', name: 'Bangchak green innovation pipeline + GDrive sync', team: 'ecosystem', agent: 'smart_green_product_orchestrator', action: 'update-pipeline', outputKey: 'bgkSales' },
      { id: 'ca-kbank-sales', name: 'KBANK ESG data pipeline + GDrive sync', team: 'revenue', agent: 'financial_model_capital_planner', action: 'update-pipeline', outputKey: 'kbankSales' },
      { id: 'ca-scb-sales', name: 'SCB Scope 3 data pipeline + GDrive sync', team: 'revenue', agent: 'financial_model_capital_planner', action: 'update-pipeline', outputKey: 'scbSales' },
      { id: 'ca-bbl-sales', name: 'BBL bundled product pipeline + GDrive sync', team: 'revenue', agent: 'financial_model_capital_planner', action: 'update-pipeline', outputKey: 'bblSales' },
      { id: 'ca-ob-sales', name: 'One Bangkok deal pipeline + GDrive sync', team: 'growth', agent: 'deal_design_pitch_engineer', action: 'update-pipeline', outputKey: 'obSales' },
      { id: 'ca-fp-sales', name: 'Frasers portfolio pipeline + GDrive sync', team: 'ecosystem', agent: 'smart_green_product_orchestrator', action: 'update-pipeline', outputKey: 'fpSales' },
      { id: 'ca-cpn-sales', name: 'CPN mall portfolio pipeline + GDrive sync', team: 'growth', agent: 'sales_playbook_account_selector', action: 'update-pipeline', outputKey: 'cpnSales' },
      { id: 'ca-wha-sales', name: 'WHA industrial estate pipeline + GDrive sync', team: 'growth', agent: 'operations_compliance_mission_planner', action: 'update-pipeline', outputKey: 'whaSales' },
      { id: 'ca-all-docs', name: 'Sync all 13 company strategy docs to Google Drive', team: 'intelligence', agent: 'market_intelligence_strategist', action: 'sync-all-company-docs', outputKey: 'allDocSync' },
    ],
  },
];
